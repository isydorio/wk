...
begin
   ...
   Try
     ...
     if jsonObj.GetValue<string>('op') = 'post' then
        begin
               ...
               begin
                ...
                begin
                  ...
                  Try
                    ...
                    begin
                      FormDB.FDCommand1.CommandText.Clear;
                      FormDB.FDCommand1.CommandText.Add('DELETE FROM public.endereco_integracao Where idendereco='+QuotedStr(FormDB.FDQenderecoidendereco.AsString));
                      FormDB.FDCommand1.Execute;
                      FormDB.FDCommand1.CommandText.Clear;
                      FormDB.FDCommand1.CommandText.Add('DELETE FROM public.endereco Where idendereco='+QuotedStr(FormDB.FDQenderecoidendereco.AsString));
                      FormDB.FDCommand1.Execute;
                      FormDB.FDQendereco.Next;
                    end;
                    FormDB.FDCommand1.CommandText.Clear;
                    FormDB.FDCommand1.CommandText.Add('DELETE FROM public.pessoa Where idpessoa='+QuotedStr(FormDB.FDQpessoaidpessoa.AsString));
                    FormDB.FDCommand1.Execute;
                    FormDB.FDConnection.Commit;
